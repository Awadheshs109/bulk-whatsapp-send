// Full index.js (Complete and updated version with all fixes; cross-checked; removed reliance on 'Media' column in Excel; media now independent and sent from assets folder to all contacts)
...
// --- Load contacts from XLSX (no 'Media' column needed now) ---
...
app.post('/api/send-messages', async (req, res) => {
  ...
  const { successCount, failureCount, successNumbers = [], failedNumbers = [], details = [] } = await sendMessages(sock, contactsData, customGenerateMessage);
